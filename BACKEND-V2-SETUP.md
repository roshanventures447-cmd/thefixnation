...
4. Select **Deploy > Manage deployments > Edit**.
5. Choose **New version**, execute as **Me**, and access **Anyone**.
6. Deploy. If Google gives a new `/exec` URL, replace the `all` URL in `js/lead-config.js`.
